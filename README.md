...
A simple and reusable Datetimepicker component for React forked from ([React Date Picker](https://www.npmjs.com/package/react-datepicker)) ([Demo](https://reactdatepicker.com/))
